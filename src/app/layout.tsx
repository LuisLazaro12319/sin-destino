...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "ropa por mayor",
    "fábrica de ropa",
    "streetwear mayorista Argentina",
  ],
  openGraph: {
    type: "website",
    locale: "es_AR",
